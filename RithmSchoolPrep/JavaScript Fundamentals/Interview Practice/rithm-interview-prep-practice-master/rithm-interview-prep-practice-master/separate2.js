...
function separate(array) {
  // return a concated array filtered over every element
  return (
    []
      // filter out cats
      .concat(array.filter((word) => word === "cat"))
      // filter out water
      .concat(array.filter((word) => word === "water"))
      // filter out dogs
      .concat(array.filter((word) => word === "dog"))
  );
}
